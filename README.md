...
A versão final de entrega deste projeto corresponde à tag **`v1.0-final-source-clean`** (branch `final-source-clean`). Este repositório deve ser avaliado a partir dessa tag, e não a partir do estado geral de outras branches ou de protótipos mais antigos.
